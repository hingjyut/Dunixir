defmodule Block.Validation.Local.PreIssuerTest do
  ...
  @block_with_invalid_preIssuer_1 %{
    "version" => 10,
    "nonce" => 10_000_000_042_832,
    "number" => 0,
    "powMin" => 68,
  ...
  @block_with_invalid_preIssuer_2 %{
    "version" => 10,
    "nonce" => 10_000_000_042_832,
    "number" => 10000,
    "powMin" => 68,
  ...
  test "validates block previous issuer" do
    assert PreIssuer.valid(@block_with_valid_preIssuer_1)
    assert PreIssuer.valid(@block_with_valid_preIssuer_2)
    refute PreIssuer.valid(@block_with_invalid_preIssuer_1)
    refute PreIssuer.valid(@block_with_invalid_preIssuer_2)
  end
end
