defmodule Block.Validation.Local.BlockSignatureTest do
  use ExUnit.Case
  doctest Block.Validation.Local.BlockSignature

  @block_with_valid_block_signature %{
    "version" => 10,
  ...
  @block_with_invalid_block_signature %{
    "version" => 10,
    "nonce" => 100_000_000_001,
    "number" => 0,
    "powMin" => 0,
    ...
    "issuer" => "DNann1Lh55eZMEDXeYt59bzHbA3NJR46DeQYCS2qQdLV",
    "signature" =>
      "A+x0F9pUcFTeqU3KEvmjGaPjnWt2uWkWCO43VXsBYCLCrjKkwU0EqJouETQKeQ7t7ukOiOyIrXW7+JBbzXaIBQ==",
    "hash" => "D06BB9FEE8D9E59892283D96A6B4D7B3937A177FB1F2B435A60E949099837355",
    "parameters" =>
      "0.007376575:3600:1200:0:40:604800:31536000:1:604800:604800:0.9:31536000:3:20:960:10:0.6666666666666666:1489675722:1489675722:3600",
    "previousHash" => nil,
  ...
  alias Block.Validation.Local.BlockSignature, as: BlockSignature

  test "Check that valid block signature is correctly validated" do
    assert BlockSignature.valid(@block_with_valid_block_signature)
  end

  test "Check that invalid block signature is correctly refused" do
    refute BlockSignature.valid(@block_with_invalid_block_signature)
  end
end
