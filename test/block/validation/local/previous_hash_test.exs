defmodule Block.Validation.Local.PreviousHashTest do
  use ExUnit.Case
  doctest Block.Validation.Local.PreviousHash
  ...
  alias Block.Validation.Local.PreviousHash, as: Hash
  test "check number and previous hash" do
    assert Hash.valid(@block_number_true)
    refute Hash.valid(@block_without_previousHash)
    assert Hash.valid(@block_number_zero)
    refute Hash.valid(@block_zero_with_previousHash)
  end
