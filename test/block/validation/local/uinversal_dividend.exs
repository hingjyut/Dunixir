defmodule Block.Validation.Local.UniversalDividendTest do
  use ExUnit.Case
  doctest Block.Validation.Local.UniversalDividend
  ...
  alias Block.Validation.Local.UniversalDividend, as: UniversalDividend

  test "Check if first block is nil" do
    assert UniversalDividend.valid(@valid_first_block)
  end

  test "Check if non empty universal dividend in first block is correctly refused" do
    refute UniversalDividend.valid(@invalid_first_block)
  end
end
