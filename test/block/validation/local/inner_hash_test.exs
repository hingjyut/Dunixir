defmodule Block.Validation.Local.InnerHashTest do
  use ExUnit.Case
  doctest Block.Validation.Local.InnerHash

  @block_with_valid_inner_hash %{
      "version" => 10,
      "nonce" => 100000000001,
      "number" => 0,
      "powMin" => 0,
      "time" => 1489672122,
      "medianTime" => 1489672122,
      "membersCount" => 2,
      "monetaryMass" => nil,
      "unitBase" => 0,
      "issuersCount" => 0,
      ...
      "signature" => "N+x0F9pUcFTeqU3KEvmjGaPjnWt2uWkWCO43VXsBYCLCrjKkwU0EqJouETQKeQ7t7ukOiOyIrXW7+JBbzXaIBQ==",
      "hash" => "D06BB9FEE8D9E59892283D96A6B4D7B3937A177FB1F2B435A60E949099837355",
      "parameters" => "0.007376575:3600:1200:0:40:604800:31536000:1:604800:604800:0.9:31536000:3:20:960:10:0.6666666666666666:1489675722:1489675722:3600",
      "previousHash" => nil,
      "previousIssuer" => nil,
  ...
  @block_with_incorrect_inner_hash %{
      "version" => 10,
      "nonce" => 100000000001,
      "number" => 0,
      "powMin" => 0,
      ...
      "previousHash" => nil,
      "previousIssuer" => nil,
      "inner_hash" => "C7DED077D6093B6E1210061D7EB43C7F006C6F656EF35A4F60E80B7B3CCBD989",
      "dividend" => nil,
      "identities" => [
        "DNann1Lh55eZMEDXeYt59bzHbA3NJR46DeQYCS2qQdLV:1eubHHbuNfilHMM0G2bI30iZzebQ2cQ1PC7uPAw08FGMMmQCRerlF/3pc4sAcsnexsxBseA/3lY03KlONqJBAg==:0-E3B0C44298FC1C149AFBF4C8996FB92427AE41E4649B934CA495991B7852B855:tic",
        "DKpQPUL4ckzXYdnDRvCRKAm1gNvSdmAXnTrJZ7LvM5Qo:lcekuS0eP2dpFL99imJcwvDAwx49diiDMkG8Lj7FLkC/6IJ0tgNjUzCIZgMGi7bL5tODRiWi9B49UMXb8b3MAw==:0-E3B0C44298FC1C149AFBF4C8996FB92427AE41E4649B934CA495991B7852B855:toc"
  ...
  alias Block.Validation.Local.InnerHash, as: InnerHash

  test "Check that valid inner hash are correctly validated" do
    assert InnerHash.valid(@block_with_valid_inner_hash)
  end
  
  test "Check that incorrect inner hash are correctly refused" do
    refute InnerHash.valid(@block_with_incorrect_inner_hash)
  end
end
